	...
	<style>
		...
		screen and (device-height <= 900px) and (height <= 900px) and (orientation: landscape) {
			...
			.recent-blogs .blog-container img{
				width: 50%;
				height: 100%;
				aspect-ratio: 1;
				object-fit: cover;
			...
			.recent-blogs .blog-text .blog-text-content p:not(.date){
				font-size: 14px;
				color: var(--black);
				font-weight: 400;
				line-height: 120%;
			...
			.recent-blogs .blog-text span img{
				width: 20px;
				height: 20px;
				aspect-ratio: 1;
				object-fit: cover;
